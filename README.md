...
$$\text{WoE}_i = \ln\left(\frac{\text{Good Rate}_i}{\text{Bad Rate}_i}\right) = \ln\left(\frac{p_i}{1-p_i}\right)$$
...
1. **Logistic Regerssion**  
   ...
   ![Logistic Regression](plots/figures/logistic_regression_plot_without_woe.png)
